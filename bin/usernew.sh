...
clear
echo -e "${RED}════════════════════════════════════════════${NC}"
echo -e "\E[47;1;30m              ⇱ CREATE ACCOUNT ⇲            \E[0m"
echo -e "${RED}════════════════════════════════════════════${NC}"
echo -e "${LIGHT}"
...
read -p "limit IP: " max
folder="/etc/dvs/limit/ssh/ip/"
if [ ! -d "$folder" ]; then
    mkdir -p "$folder"
else
    echo ""
fi
echo $max >/etc/dvs/limit/ssh/ip/$Login
...
#echo "$login $max" >> /root/limitssh.txt
clear
...
echo -e ""
echo -e "${RED}════════════════════════════════════════════${NC}"
echo -e " \E[47;1;30m          ⇱ INFORMASI AKUN SSH ⇲          \E[0m"
echo -e "${RED}════════════════════════════════════════════${NC}"
...
echo -e "Expired: $expi"
echo -e "limit ip: $max"
echo -e "${RED}═════════════════${NC}${LIGHT}HOST-SSH${NC}$RED═══════════════════${NC}"
echo -e "IP/Host: $IP"
...
echo -e "${RED}═══════════════${NC}${LIGHT}Service-Port${NC}$RED═════════════════${NC}"
echo -e "OpenSSH: 22"
